/**
 * Enhanced Host Room Hook with Async State Architecture
 * 
 * Features:
...
import { DATA_STALENESS } from "../../shared/constants/timings";
...
const isRoomStale = (room: StoredHostRoom | null): boolean => {
  ...
  return Date.now() - room.timestamp > DATA_STALENESS.ROOM;
};

export function useHostRoom(): UseHostRoomResult {
