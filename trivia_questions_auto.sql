-- ============================================================================
-- TRIVIA QUESTION PACK AND QUESTIONS (Auto-Generated IDs)
-- ============================================================================
-- This script creates a proper trivia question pack with questions using the existing trivia schema
-- Supabase will auto-generate UUIDs for the id fields
-- Run this in Supabase SQL Editor
-- ============================================================================

-- Step 1: Create a trivia question pack (auto-generates UUID for id)
...
-- Step 2: Insert trivia questions (auto-generates UUID for id)
-- We'll reference the pack by name since we don't know the auto-generated UUID
...
SELECT 
  ...
  'published'
FROM trivia_question_packs pack 
WHERE pack.name = 'General Knowledge Test' 
